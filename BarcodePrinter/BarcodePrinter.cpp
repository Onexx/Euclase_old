...
void BarcodePrinter::printBarcode(QString barcodeText, QString name)
{
    ...
    QRect nameTextRect = QRect(5*MmToDot,10.5*MmToDot,67.5*MmToDot,10*MmToDot);
    QRect barcodeRect = QRect(5*MmToDot,21*MmToDot,67.5*MmToDot,10*MmToDot);
    QRect barcodeTextRect = QRect(5*MmToDot,31.5*MmToDot,67.5*MmToDot,5*MmToDot);
